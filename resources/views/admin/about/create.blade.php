...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-gray-800">Tambah Data About</h1>
        ...
        <form action="{{ route('admin.about.store') }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <textarea name="deskripsi" 
                          ...
                          placeholder="Tulis deskripsi tentang organisasi...">{{ old('deskripsi') }}</textarea>
                @error('deskripsi')
            ...
            <div class="mb-4">
                ...
                <textarea name="visi" 
                          ...
                          placeholder="Tulis visi organisasi...">{{ old('visi') }}</textarea>
                @error('visi')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea name="misi" 
                          ...
                          placeholder="Tulis misi organisasi (pisahkan dengan baris baru untuk setiap poin)...">{{ old('misi') }}</textarea>
